...
<div class="row g-5">
    ...
    <div class="col-md-6">
        ...
        <!-- Foto utama -->
        <img id="mainImage" 
             src="../Admin/Admin/assets/Images/produk/<?= $fotos[0]['foto'] ?>" 
             class="product-img shadow">

        <!-- Thumbnail foto -->
        <div class="d-flex gap-2 mt-3">
            <?php foreach($fotos as $f) : ?>
                <img src="../Admin/Admin/assets/Images/produk/<?= $f['foto'] ?>" 
                     class="thumb-img"
    ...
    <div class="col-md-6">
        ...
        <div class="d-flex gap-3 mt-4">
            <button class="btn btn-primary px-4 py-2">Beli Sekarang</button>
            <button class="btn btn-info px-4 py-2 text-white">Masukkan Keranjang</button>
        </div>
