...
<!-- Mirrored from techzaa.in/larkon/admin/tables-gri?pages by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 21 Feb 2025 06:06:23 GMT -->
<head>
    <!-- Title Meta -->
    <meta charset="utf-8" />
    ...
    <link href="assets/css/produk.css" rel="stylesheet" type="text/css" />
...
<body>
    ...
    <div class="wrapper">
             ...
             <div class="container-fluid">
                  <div class="navbar-header">
                       <div class="d-flex align-items-center">
                            ...
                            <!-- Menu Toggle Button -->
                            <div class="topbar-item">
                                 <h4 class="fw-bold topbar-button pe-none text-uppercase mb-0">Larkon</h4>
                            </div>
                       </div>
        ...
        <div class="main-nav">
             <!-- Sidebar Logo -->
             <div class="logo-box">
                  <a href="in?pages" class="logo-dark">
                       <img src="assets/images/logo-sm.png" class="logo-sm" alt="logo sm">
                       <img src="assets/images/logo-dark.png" class="logo-lg" alt="logo dark">
                  </a>

                  <a href="in?pages" class="logo-light">
                       <img src="assets/images/logo-sm.png" class="logo-sm" alt="logo sm">
...
<!-- Mirrored from techzaa.in/larkon/admin/tables-gri?pages by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 21 Feb 2025 06:06:24 GMT --?pages>